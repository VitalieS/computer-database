...
public class EditComputer extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LOG.info("Trying to edit: " + computerId + " " + computerName + " " + introducedDate + " " + discontinuedDate + " " + companyId);

        try {
            Validate.INSTANCE.checkName(computerName);
            Validate.INSTANCE.checkId(computerId);
            ...
            ComputerService.INSTANCE.updateComputer(Long.valueOf(computerId), comp);
