...
public class View {
    ...
    private static CompanyView companyView = context.getBean("companyView", CompanyView.class);
    private static ComputerView computerView = context.getBean("computerView", ComputerView.class);
